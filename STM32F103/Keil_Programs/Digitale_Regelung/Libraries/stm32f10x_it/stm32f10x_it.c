...
/*------------------------------ Function Prototypes -------------------------*/
extern void Update_Control(void);
...
{
  Update_Control();   // Update Values for Temperature Control
...
{
  DMA1->IFCR = DMA1_FLAG_TC1;     /* Clears the corresponding TCIF flag (Transmision Complete) in the DMA1_ISR register */
  //  sollwert = Get_Desired_Value();
  // zog
  sollwert = Get_ADC_PA1();
  istwert = Get_Measured_Value();
  stoerwert = Get_ADC_PA0();
}
...
* Description    : This function handles DMA2 Channel 5 interrupt request.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
